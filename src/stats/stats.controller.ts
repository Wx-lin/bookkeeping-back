...
export class StatsController {
  ...
  @ApiOperation({ summary: '资产概览', description: '获取总资产、总负债和净资产' })
  ...
  @ApiOperation({ summary: '收支趋势', description: '获取指定时间段内的每日收支趋势' })
  ...
  @ApiOperation({ summary: '分类统计', description: '获取指定时间段内各分类的收支统计' })
  @ApiQuery({ name: 'startDate', required: false, description: '开始日期 (YYYY-MM-DD)' })
  @ApiQuery({ name: 'endDate', required: false, description: '结束日期 (YYYY-MM-DD)' })
